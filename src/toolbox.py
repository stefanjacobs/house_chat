...
TOOLBOX = generator.generate(get_energy_house_data, set_wallbox_mode, get_wallbox_status, get_dryer_machine_status, get_washing_machine_status, todo_app_api, get_energy_prices, get_todays_trash, get_tomorrows_trash, get_next_trash, get_weather_today, get_weather_week, get_current_warnings)
